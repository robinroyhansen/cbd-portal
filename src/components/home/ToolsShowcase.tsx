...
const tools = [
  {
    ...
    description: 'Get personalized CBD dosing based on your weight and goals',
  ...
  {
    name: 'Strength Calculator',
    description: 'Convert between %, mg/ml, and compare products',
  ...
  {
    name: 'Pet Dosage Calculator',
    description: 'Species-specific dosing for dogs, cats, and horses',
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900 mb-3">
            Free CBD Tools & Calculators
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Evidence-based calculators to help you use CBD safely and effectively
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-4">
                Check potential interactions between CBD and your medications. Covers 141 common drugs
                including blood thinners, antidepressants, seizure medications, and more.
              </p>
