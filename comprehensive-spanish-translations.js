...
// Comprehensive Spanish translations (high quality, natural sounding)
...
console.log('Created', Object.keys(spanishTranslations).length, 'Spanish translations');

// Save translations
fs.writeFileSync('comprehensive-spanish-translations.json', JSON.stringify(spanishTranslations, null, 2));
console.log('Comprehensive Spanish translations saved');

// Show missing count
console.log('Still need to translate:', 722 - Object.keys(spanishTranslations).length, 'more terms');