#!/usr/bin/env node
/**
 * Finnish Translation Script - DESC Batch 15 (specific articles)
...
function buildPrompt(article) {
  return `You are a professional translator. Translate this CBD health article from German to Finnish.

CRITICAL: All output text MUST be in Finnish language, NOT German or English!
  ...
  try {
    ...
    for (let i = 0; i < articles.length; i++) {
      ...
      try {
        ...
        // Rate limiting: wait 3 seconds between requests to avoid hitting rate limits
